    ...
    function r() {
        ...
        this.$rules = {
            ...
            {  
                ...
                "जारी|भंग|आम|करो|कोशिश|पकड़े|अंतमे)"
            },
            {  
                token: "keyword.other",
                regex: "(?:तंत्र|बाहर|कक्षा|सार्वजनिक|सार्वजनीक|स्थिर|"+
                "सार|अंतरापृष्ठ|निजी|सुरक्षित|इस|विरासेगा|"+
                "उच्च|लागू|फेके|प्रिंट|"+
                "रिक्त|जरूरी|आम|समूह|वापस|नई|वर्ग|अंतिम|"+
                
                "धागे|चलनेयोग्य|"+
                "अंकगणितत्रुटि|फ़ाइलप्राप्तीमेत्रुति|ट्रामअनुक्रमांकसीमाकेबाहारत्रुति|"+
                "सुरक्षात्रुटि|त्रुटि)"
            },
            /*place thes bove above block (?:\\s+|\\n*|\\{|\\}|\\(|\\))*/
            {  
                token: "variable.language",
                regex: "(?:अंक|बाइट|"+
                "छोटा|लंबा|फ्लोट|बड़ा|वर्ण|डोर|बूलियन|दोहरा)"
            },{  
                token: "keyword.other",
                regex: "(?:त्रुटि)"
