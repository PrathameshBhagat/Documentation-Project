define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
    ...
    o.inherits(r, e), r.getTagRule = function(e) {
        return {
    ...
    function o(e) {
        ...
        this.$rules = {
            no_regex: [i.getStartRule("doc-start"), r("no_regex"), {
                token: "string",
                regex: "'(?=.)",
                next: "qstring"
            }, {
            ...
            start: [i.getStartRule("doc-start"), r("start"), {
                token: "string.regexp",
                regex: "\\/",
                next: "regex"
            }, {
    ...
    a.inherits(o, e), t.JavaScriptHighlightRules = o
    ...
    (function() {
        this.checkOutdent = function(e, t) {
            ...
            r = this.$getIndent(e.getLine(r.row));
            e.replace(new o(t, 0, t, n - 1), r)
    ...
    r.inherits(t, e),
        function() {
            this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/, this.foldingStopMarker = /^[^\[\{\(]*([\}\]\)])|^[\s\*]*(\*\/)/, this.singleLineBlockCommentRe = /^\s*(\/\*).*\*\/\s*$/, this.tripleStarBlockCommentRe = /^\s*(\/\*\*\*).*\*\/\s*$/, this.startRegionRe = /^\s*(\/\*|\/\/)#?region\b/, this._getFoldWidgetBase = this.getFoldWidget, this.getFoldWidget = function(e, t, n) {
                ...
                return !e && this.startRegionRe.test(r) ? "start" : e
            }, this.getFoldWidgetRange = function(e, t, n, r) {
                var o = e.getLine(n);
                if (this.startRegionRe.test(o)) return this.getCommentRegionBlock(e, o, n);
                var a = o.match(this.foldingStartMarker);
                if (a) {
                    var i = a.index;
                    if (a[1]) return this.openingBracketBlock(e, a[1], n, i);
                    var s = e.getCommentFoldRange(n, i + a[0].length, 1);
                    return s && !s.isMultiLine() && (r ? s = this.getSectionRange(e, n) : "all" != t && (s = null)), s
                }
                if ("markbegin" !== t) return (a = o.match(this.foldingStopMarker)) ? (i = a.index + a[0].length, a[1] ? this.closingBracketBlock(e, a[1], n, i) : e.getCommentFoldRange(n, i, -1)) : void 0
            }, this.getSectionRange = function(e, t) {
                for (var n = (s = e.getLine(t)).search(/\S/), r = t, o = s.length, a = t += 1, i = e.getLength(); ++t < i;) {
                    var s, l = (s = e.getLine(t)).search(/\S/);
                    if (-1 !== l) {
                        if (l < n) break;
                ...
                return new g(r, o, a, e.getLine(a).length)
            }, this.getCommentRegionBlock = function(e, t, n) {
                for (var r = t.search(/\s*$/), o = e.getLength(), a = n, i = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++n < o;) {
                    t = e.getLine(n);
                    var l = i.exec(t);
                    if (l && (l[1] ? s-- : s++, !s)) break
                }
                if (a < n) return new g(a, r, n, t.length)
            }
        }.call(t.prototype)
    ...
    function r() {
        this.HighlightRules = i, this.$outdent = new s, this.$behaviour = new c, this.foldingRules = new g
    }
    var o = e("../lib/oop"),
        a = e("./text").Mode,
    ...
    o.inherits(r, a),
        function() {
            this.lineCommentStart = "//", this.blockComment = {
                ...
                var r, o = this.$getIndent(t),
                    a = this.getTokenizer().getLineTokens(t, e),
                    i = a.tokens,
                    a = a.state;
                if (i.length && "comment" == i[i.length - 1].type) return o;
                if ("start" == e || "no_regex" == e)(r = t.match(/^.*(?:\bcase\b.*:|[\{\(\[])\s*$/)) && (o += n);
                else if ("doc-start" == e) {
                ...
                var e = new l(["ace"], "ace/mode/javascript_worker", "JavaScriptWorker");
    ...
    function r() {
        ...
        this.$rules = {
            ...
            {  
                token: "storage.type",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:अगर|या|केलिए|जब-तक|जबतक|जब|करो|बदले|बदलो|यदि|जारी|भंग|आम|करो|कोशिश|पकड़े|अंतमे)((?=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },
            {  //just to offer precedence
                token: "keyword.other",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:दिनांकऔरसमयस्वरूपण|दिनांकऔरसमय)((?=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },
            {  
                token: "keyword.other",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:तंत्र|बाहर|कक्षा|सार्वजनिक|सार्वजनीक|स्थिर|सार|अंतरापृष्ठ|निजी|सुरक्षित|इस|विरासेगा|उच्च|लागू|फेके|प्रिंट|रिक्त|जरूरी|समूह|वापस|नई|वर्ग|अंतिम|धागा|चलनेयोग्य|इअंक|दिनांक|समय|स्कैनर|अगलीरेखा|अगलादोहरा|अगलाबाइट|अगलाबड़ा|अगलाफ्लोट|अगलाअंक|अगलालंबा|अगलाछोटा|मान|लंबाई|अभी|मे|चले|शुरू|ज़्यादा|कम|मूल|शुद्ध|अनुक्रमांक|कोई|स्वरूप|रूप|अंकगणितत्रुटि|फ़ाइलप्राप्तीमेत्रुति|ट्रामअनुक्रमांकसीमाकेबाहारत्रुति|सुरक्षात्रुटि|त्रुटि)((?=\s+|$|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },//errors after dhage , runnable  /strarting from मान .. रूप replace methords even from arrays ,enum userinput,date etc ,math ,stringetc ,exception   
            {  
                token: "variable.language",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:अंक|बाइट|छोटा|लंबा|फ्लोट|बड़ा|वर्ण|डोर|बूलियन|दोहरा)((?=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },
            {  
                token: "keyword.other",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:त्रुटि)((?=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },/*some are above numerics 
...
regex = XRegExp("(?:^|[^\\p{Devanagari}\\p{L}])मंत्री(?=[^\\p{Devanagari}\\p{L}]|$)");
        ...
        }, this.embedRules(a, "doc-", [a.getEndRule("start")]), this.normalizeRules()
    }
    var o = e("../lib/oop"),
        a = e("./doc_comment_highlight_rules").DocCommentHighlightRules,
        e = e("./text_highlight_rules").TextHighlightRules;
    o.inherits(r, e), t.JavaHighlightRules = r
    ...
    r.inherits(e, o),
        function() {
            this.importRegex = /^import /, this.getCStyleFoldWidget = this.getFoldWidget, this.getFoldWidget = function(e, t, n) {
                if ("markbegin" === t) {
                    var r = e.getLine(n);
                    if (this.importRegex.test(r) && (0 == n || !this.importRegex.test(e.getLine(n - 1)))) return "start"
                }
                ...
                var o = (s = e.getLine(n)).match(this.importRegex);
                if (!o || "markbegin" !== t) return this.getCstyleFoldWidgetRange(e, t, n, r);
                for (var t = o[0].length, a = e.getLength(), r = n, i = n; ++n < a;) {
                    var s = e.getLine(n);
                    if (!s.match(/^\s*$/)) {
                        if (!s.match(this.importRegex)) break;
                        i = n
                    }
                }
                return r < i ? (o = e.getLine(i).length, new l(r, t, i, o)) : void 0
            }
        }.call(e.prototype)
}), define("ace/mode/javaa", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/java_highlight_rules", "ace/mode/folding/java"], function(e, t, n) {
    "use strict";

    function r() {
        a.call(this), this.HighlightRules = i, this.foldingRules = new s
    }
    var o = e("../lib/oop"),
        a = e("./javascript").Mode,
        i = e("./java_highlight_rules").JavaHighlightRules,
        s = e("./folding/java").FoldMode;
    o.inherits(r, a),
        function() {
            this.createWorker = function(e) {
                return null
            }, this.$id = "ace/mode/javaa", this.snippetFileId = "ace/snippets/java"
        }.call(r.prototype), t.Mode = r
}), window.require(["ace/mode/javaa"], function(e) {
